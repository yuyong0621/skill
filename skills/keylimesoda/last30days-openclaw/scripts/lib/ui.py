...
def show_diagnostic_banner(diag: dict):
    ...
    if IS_TTY:
        ...
        if has_openai:
            ...
            lines.append(f"{Colors.DIM}│{Colors.RESET}     └─ Add to ~/.openclaw/workspace/.secrets/last30days.env            {Colors.DIM}│{Colors.RESET}")
        ...
        lines.append(f"{Colors.DIM}│{Colors.RESET}                                                     {Colors.DIM}│{Colors.RESET}")
        lines.append(f"{Colors.DIM}│{Colors.RESET}  Config: {Colors.BOLD}~/.openclaw/workspace/.secrets/last30days.env{Colors.RESET}                  {Colors.DIM}│{Colors.RESET}")
        lines.append(f"{Colors.DIM}└─────────────────────────────────────────────────────┘{Colors.RESET}")
    else:
        ...
        if has_openai:
            ...
            lines.append("│     └─ Add to ~/.openclaw/workspace/.secrets/last30days.env            │")
        ...
        lines.append("│                                                     │")
        lines.append("│  Config: ~/.openclaw/workspace/.secrets/last30days.env                  │")
        lines.append("└─────────────────────────────────────────────────────┘")
